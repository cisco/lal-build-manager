...
## Config
A per-machine configuration file in `~/.lal/config` generated by `lal configure`. This is an example of environments, artifactory settings and mounts for the edonus team.
